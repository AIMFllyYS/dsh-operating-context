	...
	factory: (require) => {
		...
		*/
		...
		function Loaded({ controller, useSnapshot, t }) {
			...
			const followsSavedChoice = draft.preset === void 0 && !draft.custom;
			const savedChoice = state.selectedWindow;
			const savedChoiceIsPreset = savedChoice !== void 0 && WINDOW_PRESETS.some((preset) => preset.tokens === savedChoice);
			const customActive = draft.custom || followsSavedChoice && savedChoice !== void 0 && !savedChoiceIsPreset;
			const customText = draft.custom ? draft.customText : customActive && savedChoice !== void 0 ? formatCapacity(savedChoice) : draft.customText;
			const target = draft.custom ? typed !== void 0 && Number.isSafeInteger(typed) && typed > 0 ? typed : void 0 : draft.preset ?? savedChoice ?? current;
					...
					/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						...
						children: [
							/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
								...
								}), displayedWindow === void 0 ? null : /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
									className: Section_module_css_default.current,
									children: fill(t("current"), { window: formatCapacity(displayedWindow) })
								})]
							}),
							/* @__PURE__ */ (0, react_jsx_runtime.jsx)("p", {
								className: Section_module_css_default.hint,
							...
							customActive ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
